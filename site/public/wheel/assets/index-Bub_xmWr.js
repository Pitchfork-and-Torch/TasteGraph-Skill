...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function Xl(){return new In({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Io(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function Yl(){return new In({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Io(),fragmentShader:`
...
`)}function Qg(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function rs(i){return i!==""}function ic(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function sc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const t_=/^[ \t]*#include +<([\w\d./]+)>/gm;function uo(i){return i.replace(t_,n_)}const e_=new Map;function n_(i,t){let e=Ht[t];if(e===void 0){const n=e_.get(t);if(n!==void 0)e=Ht[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return uo(e)}const i_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function rc(i){return i.replace(i_,s_)}function s_(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ac(i){let t=`precision ${i.precision} float;
...
`].filter(rs).join(`
`)),a=uo(a),a=ic(a,e),a=sc(a,e),o=uo(o),o=ic(o,e),o=sc(o,e),a=rc(a),o=rc(o),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+f);const b=w+m+a,y=w+f+o,U=tc(s,s.VERTEX_SHADER,b),P=tc(s,s.FRAGMENT_SHADER,y);s.attachShader(_,U),s.attachShader(_,P),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(C){if(i.debug.checkShaderErrors){const k=s.getProgramInfoLog(_).trim(),O=s.getShaderInfoLog(U).trim(),W=s.getShaderInfoLog(P).trim();let Z=!0,G=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,U,P);else{const K=nc(s,U,"vertex"),H=nc(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
`;document.body.appendChild(me);const fc=me.querySelector("img"),pc=me.querySelector(".lightbox-credit"),mc=me.querySelector(".lb-title"),ns=me.querySelector(".lb-handle"),Xn=me.querySelector(".lb-source"),is=me.querySelector(".lb-source-muted"),gc=me.querySelector(".lb-kicker");function Fo(){me.classList.remove("is-open"),Xn.removeAttribute("href")}me.querySelector(".lightbox-close").addEventListener("click",Fo);me.addEventListener("click",i=>{i.target===me&&Fo()});var xc;(xc=me.querySelector(".lightbox-stage"))==null||xc.addEventListener("click",i=>i.stopPropagation());function mh(i,t,e=null){const n=String((e==null?void 0:e.title)||t||"").trim(),s=String((e==null?void 0:e.credit)||"").trim(),r=String((e==null?void 0:e.href)||"").trim(),a=s.replace(/^@/,"");if(fc.src=i,fc.alt=n||t||"TasteGraph still",pc)if(pc.hidden=!1,mc&&(mc.textContent=n||"Public still"),ns&&(a?(ns.hidden=!1,ns.textContent=`@${a}`):(ns.hidden=!0,ns.textContent="")),gc&&(gc.textContent=r||a?"Found on X":"Still"),r){Xn.hidden=!1,Xn.href=r,Xn.setAttribute("aria-label",a?`Open original post by @${a}`:"Open original post"),is&&(is.hidden=!0);const o=Xn.querySelector(".lb-source-label");o&&(o.textContent=a?`Open original · @${a}`:"Open original post")}else Xn.hidden=!0,Xn.removeAttribute("href"),is&&(is.hidden=!1,is.textContent=a?`Shared by @${a} (post link not recovered)`:"Source link not recovered for this still");me.classList.add("is-open")}window.addEventListener("keydown",i=>{i.key==="Escape"&&Fo()});a0();e0();let Gi="wheel",Ae=null,nn="all",xr=!1,Mr=!1;const gh={all:"All",music:"Music",myth:"Myth-tech",sketch:"Sketch",defensive:"Defensive",motion:"Motion",pro:"Pro UI",speculative:"Speculative",fashion:"Fashion"};async function _h(){const t=`/wheel/ingest-stills.json?v=${No}`;try{const e=await fetch(t,{cache:"no-cache"});if(!e.ok)throw new Error(`HTTP ${e.status}`);Ae=await e.json()}catch(e){console.warn("[TasteGraph pie] ingest-stills load failed",e),Ae={count:0,items:Ve.flatMap(n=>(n.examples||[]).map(s=>({src:s.src,title:s.caption,credit:s.credit,href:s.href,registers:[n.id],featured:!0,batch:"featured-wheel",kind:"image"})))},Ae.count=Ae.items.length}vh(),Oo()}function vh(){const i=document.getElementById("grid-filters");if(!i)return;i.innerHTML="";const t=Array.isArray(Ae==null?void 0:Ae.items)?Ae.items:[],e=new Set;t.forEach(s=>{(Array.isArray(s.registers)?s.registers:[]).forEach(r=>e.add(String(r)))}),["all",...Ve.map(s=>s.id)].forEach(s=>{if(s!=="all"&&!e.has(s))return;const r=document.createElement("button");r.type="button",r.className="grid-filter"+(nn===s?" is-active":""),r.dataset.filter=s,r.textContent=gh[s]||s,r.setAttribute("aria-pressed",nn===s?"true":"false"),r.addEventListener("click",()=>{nn=s,vh(),Oo()}),i.appendChild(r)})}function Oo(){const i=document.getElementById("ingest-grid"),t=document.getElementById("grid-count");if(!i)return;const e="/wheel/";let n=Array.isArray(Ae==null?void 0:Ae.items)?Ae.items:[];if(nn!=="all"&&(n=n.filter(r=>(Array.isArray(r.registers)?r.registers:[]).includes(nn))),t){const r=(Ae==null?void 0:Ae.count)??n.length;t.textContent=nn==="all"?`${n.length} stills`:`${n.length} · ${gh[nn]||nn}`,nn==="all"&&r&&(t.textContent=`${r} stills ingested`)}if(i.innerHTML="",!n.length){const r=document.createElement("p");r.className="ingest-empty",r.textContent=nn==="all"?"No stills in the public ingest catalog yet.":"No stills tagged to this register. Try All.",i.appendChild(r);return}const s=document.createDocumentFragment();n.forEach(r=>{const a=document.createElement("figure");a.className="ingest-card",a.tabIndex=0;const o=document.createElement("img"),l=e+String(r.src||"").replace(/^\//,"");if(o.src=l,o.alt=String(r.title||r.credit||"TasteGraph still"),o.loading="lazy",o.decoding="async",o.onerror=()=>{o.replaceWith(Object.assign(document.createElement("div"),{className:"img-fallback",textContent:"Missing still"}))},r.featured){const d=document.createElement("span");d.className="cap-badge",d.textContent="Featured",a.appendChild(d)}const c=document.createElement("figcaption"),h=document.createElement("span");if(h.className="cap-title",h.textContent=String(r.title||"Still"),c.appendChild(h),r.href){const d=document.createElement("a");d.className="cap-source",d.href=String(r.href),d.target="_blank",d.rel="noopener noreferrer",d.textContent=r.credit?`Source ${r.credit}`:"Source on X",d.addEventListener("click",p=>p.stopPropagation()),c.appendChild(d)}else if(r.credit){const d=document.createElement("span");d.className="cap-source muted",d.textContent=String(r.credit),c.appendChild(d)}a.append(o,c);const u=()=>mh(l,String(r.title||""),{title:String(r.title||""),credit:String(r.credit||""),href:String(r.href||"")});a.addEventListener("click",u),a.addEventListener("keydown",d=>{(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),u())}),s.appendChild(a)}),i.appendChild(s)}function mo(i,{pushUrl:t=!0}={}){const e=i==="grid"?"grid":"wheel";Gi=e;const n=document.getElementById("stage-wheel"),s=document.getElementById("stage-grid"),r=document.getElementById("view-wheel"),a=document.getElementById("view-grid"),o=document.getElementById("foot-primary"),l=e==="grid";if(document.body.classList.toggle("is-grid-view",l),n&&(n.classList.toggle("is-hidden",l),n.hidden=l),s&&(s.classList.toggle("is-hidden",!l),s.hidden=!l),r&&(r.classList.toggle("is-active",!l),r.setAttribute("aria-selected",l?"false":"true")),a&&(a.classList.toggle("is-active",l),a.setAttribute("aria-selected",l?"true":"false")),vr&&(vr.textContent=l?"Scroll the archive · Click a still · Filter by register":"Drag to orbit · Scroll to zoom · Hover a slice"),o&&(o.textContent=l?"Public-art stills · source-linked when known":"Exact arcs · sum 100% = 360°"),Mr&&typeof ye<"u"&&ye&&(ye.autoRotate=!l&&!ii,ye.enabled=!l),l?(xr=!1,Ae?Oo():_h()):Mr&&(Th(),requestAnimationFrame(()=>{try{Tr()}catch{}})),t)try{const c=new URL(window.location.href);l?c.searchParams.set("view","grid"):c.searchParams.delete("view"),window.history.replaceState({view:e},"",c.pathname+c.search+c.hash)}catch{}}function l0(){document.querySelectorAll(".view-btn[data-view]").forEach(t=>{t.addEventListener("click",()=>mo(t.getAttribute("data-view")||"wheel"))});let i="wheel";try{const e=(new URLSearchParams(window.location.search).get("view")||"").toLowerCase(),n=(window.location.hash||"").replace(/^#/,"").toLowerCase();(e==="grid"||n==="grid")&&(i="grid")}catch{}mo(i,{pushUrl:!1})}_h();const Ne=new Yc;Ne.background=new Vt(658192);const Un=new ke(42,1,.1,100);Un.position.set(0,6.5,8.5);const he=new z_({antialias:!0,alpha:!1,powerPreference:"high-performance"});he.setPixelRatio(Math.min(window.devicePixelRatio||1,1.75));he.outputColorSpace=be;he.toneMapping=Ec;he.toneMappingExposure=1.25;he.shadowMap.enabled=!0;he.shadowMap.type=yc;fo.appendChild(he.domElement);const c0=new ho(he);Ne.environment=c0.fromScene(new t0,.04).texture;const ye=new H_(Un,he.domElement);ye.enableDamping=!0;ye.dampingFactor=.07;ye.minDistance=5;ye.maxDistance=16;ye.maxPolarAngle=Math.PI*.49;ye.target.set(0,.4,0);ye.enablePan=!1;ye.autoRotate=!ii;ye.autoRotateSpeed=.6;Ne.add(new Kd(16777215,.38));const en=new Do(16773590,2.15);en.position.set(5.5,11,4.5);en.castShadow=!0;en.shadow.mapSize.set(2048,2048);en.shadow.camera.near=1;en.shadow.camera.far=30;en.shadow.camera.left=-8;en.shadow.camera.right=8;en.shadow.camera.top=8;en.shadow.camera.bottom=-8;en.shadow.bias=-25e-5;Ne.add(en);Ne.add(new Do(8304856,.7).translateX(-7).translateY(5).translateZ(-4));const xh=new Do(13936730,.55);xh.position.set(-2,3,8);Ne.add(xh);const h0=new qd(15788248,658452,.72);Ne.add(h0);function Mh(i,t,e=1){const s=document.createElement("canvas");s.width=256,s.height=256;const r=s.getContext("2d"),a=`#${i.toString(16).padStart(6,"0")}`,o=`#${t.toString(16).padStart(6,"0")}`,l=r.createRadialGradient(256*.35,256*.3,256*.05,256*.5,256*.55,256*.72);l.addColorStop(0,o),l.addColorStop(.35,a),l.addColorStop(1,"#0a0b10"),r.fillStyle=l,r.fillRect(0,0,256,256),r.globalAlpha=.12;for(let g=0;g<90;g++){const _=(g*37+e*13)%256;r.strokeStyle=g%3===0?"#ffffff":"#000000",r.lineWidth=1+g%2,r.beginPath(),r.moveTo(0,_),r.lineTo(256,_+(g%5-2)),r.stroke()}r.globalAlpha=.18;for(let g=0;g<4200;g++){const _=(Math.sin(e*12.3+g*1.7)*.5+.5)*256,m=(Math.cos(e*9.1+g*2.3)*.5+.5)*256;r.fillStyle=g%2?"rgba(255,255,255,0.5)":"rgba(0,0,0,0.55)",r.fillRect(_,m,1.2,1.2)}r.globalAlpha=.22,r.fillStyle="#e8c98a";for(let g=0;g<80;g++){const _=(g*97+e*41)%256,m=(g*53+e*19)%256;r.fillRect(_,m,1.5,1.5)}r.globalAlpha=1;const c=document.createElement("canvas");c.width=256,c.height=256;const h=c.getContext("2d");h.fillStyle="#6a6a6a",h.fillRect(0,0,256,256);for(let g=0;g<3e3;g++){const _=(g*61+e*7)%256,m=(g*29+e*3)%256,f=40+g*17%160;h.fillStyle=`rgb(${f},${f},${f})`,h.fillRect(_,m,2,2)}h.globalAlpha=.35;for(let g=0;g<256;g+=6){const _=90+g%40;h.fillStyle=`rgb(${_},${_},${_})`,h.fillRect(0,g,256,3)}const u=new gr(s);u.colorSpace=be,u.wrapS=u.wrapT=hs,u.repeat.set(1.2,1.2),u.anisotropy=4;const d=new gr(c);d.wrapS=d.wrapT=hs,d.repeat.set(1.6,1.6);const p=u.clone();return p.colorSpace=_n,{map:u,roughnessMap:d,bumpMap:p}}function u0(){const t=document.createElement("canvas");t.width=512,t.height=512;const e=t.getContext("2d"),n=e.createRadialGradient(512/2,512/2,512*.08,512/2,512/2,512*.5);n.addColorStop(0,"#1a1d28"),n.addColorStop(.55,"#101218"),n.addColorStop(1,"#07080c"),e.fillStyle=n,e.fillRect(0,0,512,512),e.globalAlpha=.15;for(let r=0;r<8e3;r++)e.fillStyle=r%2?"#ffffff":"#000000",e.fillRect(Math.random()*512,Math.random()*512,1,1);e.globalAlpha=.2,e.strokeStyle="#d4a85a",e.lineWidth=2,e.beginPath(),e.arc(512/2,512/2,512*.31,0,Math.PI*2),e.stroke();const s=new gr(t);return s.colorSpace=be,s}const Dr=new se(new wr(6.4,96),new _r({map:u0(),color:16777215,metalness:.22,roughness:.88}));Dr.rotation.x=-Math.PI/2;Dr.position.y=0;Dr.receiveShadow=!0;Ne.add(Dr);const Bo=new se(new Po(3.22,.028,16,128),new Lo({color:13936730,metalness:.92,roughness:.22,emissive:13936730,emissiveIntensity:.32,clearcoat:.55,clearcoatRoughness:.25}));Bo.rotation.x=Math.PI/2;Bo.position.y=.03;Ne.add(Bo);let Ri=null;if(!ii){const t=new we,e=new Float32Array(420);for(let n=0;n<140;n++){const s=Math.random()*Math.PI*2,r=2.2+Math.random()*2.4;e[n*3]=Math.cos(s)*r,e[n*3+1]=.2+Math.random()*1.6,e[n*3+2]=Math.sin(s)*r}t.setAttribute("position",new Ye(e,3)),Ri=new ud(t,new $c({color:15255946,size:.035,transparent:!0,opacity:.45,depthWrite:!1,sizeAttenuation:!0})),Ne.add(Ri)}const yr=.85,yh=3,$n=.65,d0=.28,ei=new ss;ei.position.y=.04;Ne.add(ei);const Wi=[];function f0(i,t){const e=new nh;e.absarc(0,0,yh,i,t,!0),e.absarc(0,0,yr,t,i,!1);const n=new Co(e,{depth:$n,bevelEnabled:!0,bevelThickness:.045,bevelSize:.04,bevelSegments:3,curveSegments:64});return n.rotateX(-Math.PI/2),n}let va=0;Ve.forEach((i,t)=>{const e=va,n=va+i.deg;va=n;const s=Math.PI/2-fs.degToRad(e),r=Math.PI/2-fs.degToRad(n),a=(s+r)/2,o=f0(s,r);o.translate(0,$n/2,0),o.computeVertexNormals();const l=r0[i.id]??i.color,c=Mh(l,i.accent,t+1),h=new Lo({color:16777215,map:c.map,roughnessMap:c.roughnessMap,bumpMap:c.bumpMap,bumpScale:.035,metalness:.28,roughness:.48,emissive:i.accent,emissiveIntensity:.16,envMapIntensity:1.15,clearcoat:.42,clearcoatRoughness:.28,sheen:.35,sheenRoughness:.55,sheenColor:new Vt(i.rim),side:rn}),u=new se(o,h);u.castShadow=!0,u.receiveShadow=!0,u.userData={index:t,slice:i,targetY:0,midAngle:a,baseEmissive:.16,hoverEmissive:.38};const d=new bd(o,22);u.add(new hd(d,new jc({color:i.rim,transparent:!0,opacity:.72}))),ei.add(u),Wi.push(u);const p=Sh(i.short,`${i.pct}%`,i.rim),g=(yr+yh)*.52;p.position.set(Math.cos(a)*g,$n+.35,-Math.sin(a)*g),ei.add(p),u.userData.label=p,u.userData.labelBaseY=$n+.35});const xa=Mh(1448226,13936730,99),p0=new Lo({color:16777215,map:xa.map,roughnessMap:xa.roughnessMap,bumpMap:xa.bumpMap,bumpScale:.02,metalness:.72,roughness:.28,emissive:13936730,emissiveIntensity:.22,clearcoat:.65,clearcoatRoughness:.2,envMapIntensity:1.3}),zo=new se(new Ro(yr-.06,yr-.06,$n+.12,64),p0);zo.position.y=$n/2+.02;zo.castShadow=!0;ei.add(zo);const ko=Sh("TASTEGRAPH",No,13936730);ko.position.set(0,$n+.5,0);ko.scale.set(1.5,.75,1);ei.add(ko);const m0=new Ar({color:0,transparent:!0,opacity:.35,depthWrite:!1}),Ho=new se(new wr(3.1,48),m0);Ho.rotation.x=-Math.PI/2;Ho.position.y=.02;ei.add(Ho);function Sh(i,t,e){const n=document.createElement("canvas");n.width=512,n.height=256;const s=n.getContext("2d");s.clearRect(0,0,512,256),s.fillStyle="rgba(12, 13, 18, 0.88)",g0(s,56,56,400,144,26),s.fill(),s.strokeStyle=`#${Number(e).toString(16).padStart(6,"0")}`,s.globalAlpha=.7,s.lineWidth=3,s.stroke(),s.globalAlpha=1,s.fillStyle=`#${Number(e).toString(16).padStart(6,"0")}`,s.font="700 44px Satoshi, Segoe UI, system-ui, sans-serif",s.textAlign="center",s.fillText(i,256,120),s.fillStyle="#d8d2c6",s.font="600 34px Satoshi, Segoe UI, system-ui, sans-serif",s.fillText(t,256,168);const r=new gr(n);r.colorSpace=be;const a=new ad(new qc({map:r,transparent:!0,depthWrite:!1}));return a.scale.set(1.25,.62,1),a}function g0(i,t,e,n,s,r){i.beginPath(),i.moveTo(t+r,e),i.arcTo(t+n,e,t+n,e+s,r),i.arcTo(t+n,e+s,t,e+s,r),i.arcTo(t,e+s,t,e,r),i.arcTo(t,e,t+n,e,r),i.closePath()}const _c=new tf,Sr=new Q(2,2);let Er=-1,Vo=!1;function yn(i){Er=i,Wi.forEach((t,e)=>{const n=e===i;t.userData.targetY=n?d0:0;const s=t.userData.baseEmissive??.16,r=t.userData.hoverEmissive??.38;t.userData.targetEmissive=n?r:s,t.userData.label&&(t.userData.label.material.opacity=n?1:.9,t.userData.label.scale.set(n?1.4:1.25,n?.7:.62,1))}),o0(i>=0?Ve[i]:null),vr&&(vr.textContent=i>=0?`${Ve[i].name} - ${Ve[i].pct}%`:"Drag to orbit - Scroll to zoom - Hover a slice")}function _0(i){const t=he.domElement.getBoundingClientRect();Sr.x=(i.clientX-t.left)/t.width*2-1,Sr.y=-((i.clientY-t.top)/t.height)*2+1,Vo=!0}he.domElement.addEventListener("pointermove",_0);he.domElement.addEventListener("pointerenter",()=>{ii||(ye.autoRotate=!1)});he.domElement.addEventListener("pointerleave",()=>{Vo=!1,Sr.set(2,2),ii||(ye.autoRotate=!0)});he.domElement.addEventListener("pointerdown",()=>{he.domElement.style.cursor="grabbing",ii||(ye.autoRotate=!1)});he.domElement.addEventListener("pointerup",()=>{he.domElement.style.cursor="grab"});function v0(){if(!Vo)return;_c.setFromCamera(Sr,Un);const i=_c.intersectObjects(Wi,!1);if(i.length){const t=i[0].object.userData.index;t!==Er&&yn(t),he.domElement.style.cursor="pointer"}else he.domElement.style.cursor="grab"}function Tr(){const i=Math.max(fo.clientWidth,1),t=Math.max(fo.clientHeight,1);Un.aspect=i/t,Un.updateProjectionMatrix(),he.setSize(i,t,!1)}window.addEventListener("resize",Tr);requestAnimationFrame(()=>{Tr(),setTimeout(Tr,100)});const vc=new Qd;function Eh(){if(Gi!=="wheel"){xr=!1;return}const i=Math.min(vc.getDelta(),.05);if(v0(),Wi.forEach(t=>{t.position.y=fs.damp(t.position.y,t.userData.targetY,12,i);const e=t.userData.targetEmissive??t.userData.baseEmissive??.16;t.material.emissiveIntensity=fs.damp(t.material.emissiveIntensity,e,10,i),t.userData.label&&(t.userData.label.position.y=t.userData.labelBaseY+t.position.y)}),Ri&&!ii){Ri.rotation.y+=i*.08;const t=Ri.geometry.attributes.position.array,e=vc.elapsedTime;for(let n=0;n<t.length;n+=3)t[n+1]+=Math.sin(e*.7+n)*8e-4;Ri.geometry.attributes.position.needsUpdate=!0}ye.update(),he.render(Ne,Un),requestAnimationFrame(Eh)}function Th(){Mr&&Gi==="wheel"&&(xr||(xr=!0,requestAnimationFrame(Eh)))}window.addEventListener("keydown",i=>{Gi==="wheel"&&(i.key==="ArrowRight"||i.key==="ArrowDown"?(i.preventDefault(),yn((Er+1+Ve.length)%Ve.length)):i.key==="ArrowLeft"||i.key==="ArrowUp"?(i.preventDefault(),yn((Er-1+Ve.length)%Ve.length)):i.key==="Escape"&&!me.classList.contains("is-open")&&yn(1))});yn(1);Mr=!0;l0();Gi==="wheel"&&Th();function bh(){const i=document.getElementById("boot");i&&i.classList.add("is-done")}requestAnimationFrame(()=>{Gi==="wheel"&&he.render(Ne,Un),bh()});setTimeout(bh,900);window.__tastePie={setActive:yn,SLICES:Ve,sliceMeshes:Wi,scene:Ne,camera:Un,setViewMode:mo};console.info("[TasteGraph pie] slices:",Wi.length);
