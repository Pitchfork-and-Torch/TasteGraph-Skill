...
FEATURED = {
    # 1.3.6 dump featured stills
    "2085452684598169809",  # booterart from above
    "2085221828780236871",  # solisolsoli viral figure
    "2085320562654564801",  # kak_dc GM
    "2085378752830464155",  # GalacticStones megalith
    "2085288481601753121",  # cromsovertures dark fantasy
    "2085490096648695843",  # sergeantsref sref pack
    "2085272074881282186",  # ElMetallico pixel
    "2085350177158901778",  # chxrxg hero explorations
    "2084996341953098182",  # AfnanFatimas SaaS hero
    "2085286254719992306",  # rare_jpg circuit cat
    "2085363939672801705",  # houseofuday_
    "2085396076933099941",  # iamlaurael physical art
    "2085346561119428638",  # DRUGONDRAGON glitch
    "2085293552553402450",  # Delahuntagram package icon
    "2085444030893064259",  # OVolosin Noctura
    "2085347706638143589",  # gizakdag tennis claymation
    "2085255616231321963",  # skitchism after school
    # retained prior craft (still in catalog; may remain on older stills)
    "2084908433950785757",
    "2085012706302800313",
    "2084844344259776904",
    "2084611335346925670",
