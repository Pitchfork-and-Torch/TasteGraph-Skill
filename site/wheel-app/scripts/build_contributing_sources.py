...
FEATURED = {
    # 1.3.15 pie wedge ship (09-02 dump)
    "2091620859907850652",  # iamdothash CLIAMP music
    "2094000827660734917",  # unseenai pink dune music
    "2094058896138584492",  # NEXUS_TO_NOVA temple music
    "2091940837080924509",  # doganuraldesign Stoneify myth
    "2094094082964443590",  # machineviolence halfzoid myth
    "2094027778769420561",  # Palakonweb jet myth
    "2092355119849308165",  # LouiseVisual halftone sketch
    "2092410119594152152",  # GlennHasABeard queue sketch
    "2093292927716118625",  # Av1dlive agent passport defensive
    "2094765910502298082",  # kyleanthony mapping OS defensive
    "2093920203918737775",  # insporadesign glass motion
    "2093270659824529461",  # raul_dronca ripple motion
    "2091908290838204746",  # lepadphone stroboscopic motion
    "2091946138551386283",  # DesignByMoein keyhole pro
    "2093012548031254932",  # matiNotFound vgpu pro
    "2092202909035364546",  # thedesignely Studio Pond pro
    "2091477370872168895",  # JayBorda Geomanist speculative
    "2094130855056675287",  # doganuraldesign glitter speculative
    "2093354074166980981",  # PermaDelusional statue speculative
...
def main() -> None:
    ...
    batch_order = {
        ...
        "love-2026-08-10-dump": 3,
        "love-2026-08-08-dump": 4,
